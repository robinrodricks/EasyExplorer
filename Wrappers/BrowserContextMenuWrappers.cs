...
namespace EasyExplorer
{
    ...
    internal class BrowserTVContextMenuWrapper : NativeWindow
    {
        ...
        public BrowserTVContextMenuWrapper(Explorer br)
        {
            this.br = br;
    ...
    internal class BrowserLVContextMenuWrapper : NativeWindow
    {
        ...
        /// </summary>
        /// <param name="br">The browser for which to support the ContextMenu</param>
        public BrowserLVContextMenuWrapper(Explorer br, BrowserPluginWrapper pluginWrapper)
        {
            this.br = br;
    ...
    internal static class ContextMenuHelper
    {
        ...
        /// Ctrl + C and Ctrl + V.
        /// </summary>
        public static void ProcessKeyCommands(Explorer br, object sender, KeyEventArgs e)
        {
